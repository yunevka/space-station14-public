...
ent-CrateNPCMothroach = ящик с таракамолью
    .desc = ящик с четырьмя таракамолями

ent-CrateNPCPuppyCorgi = ящик с щенками
    .desc = Ящик с единственным щенком. Авв...
ent-PetCarrier = большая переноска для животных
    .desc = Позволяет комфортно перевозить крупных животных.
